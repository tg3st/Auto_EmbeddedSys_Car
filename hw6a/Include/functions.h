...
void Rwheel_forward(void);
void Lwheel_forward(void);
void Rwheel_reverse(void);
void Lwheel_reverse(void);
void wheels_stop(void);
void turn_clockwise(void);
void turn_counter(void);

// Patterns
void run_straight(void);
void run_case_straight(void);
void run_circle(void);
void run_case_clockwise_circle(void);
void run_figure8(void);
void run_case_counterclockwise_circle(void);
void run_triangle(void);
void run_case_triangle(void);
void run_case_turn_right(void);
void wait_case(void);
